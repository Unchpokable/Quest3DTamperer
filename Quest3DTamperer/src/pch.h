...
// project lives here, and only here. Our own .cpp files include "pch.h" plus
...
// set of D3D9/D3DX9 headers stays internally consistent. Nothing here ever
// gets linked against d3dx9.lib: D3DXVECTOR3/D3DXMATRIX are only used as
// plain data types (their ctors/operators are inlined from d3dx9math.inl),
// and no D3DX9 utility function is called anywhere in this codebase.
#include <d3d9.h>
#include <d3d9types.h>
#include <d3dx9.h>
#include <d3dx9math.h>
...
// UGraphviz. Actually lives in namespace Ubpa::UGraphviz; every UGraphviz::
// use in this project relies on this using-directive to drop the Ubpa:: part.
